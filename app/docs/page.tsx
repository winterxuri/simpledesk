...
const sections = [
  {
    ...
    icon: KeyRound,
    text: "Владелец регистрируется, создаёт салон и проходит мастер настройки рабочего пространства.",
    steps: ["укажите имя, email и пароль", "введите название салона", "примите условия", "настройте нужные модули"]
  },
  {
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-6xl px-4 py-16">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-muted-foreground">
            Короткая инструкция для владельца салона: от регистрации до первых
            клиентов, мастеров, записей и отчётов.
          </p>
